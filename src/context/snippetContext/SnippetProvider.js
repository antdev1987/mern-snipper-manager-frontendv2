...
export const SnippetProvider = props =>{
    ...
    const getAllSnippetProjects = async()=>{
        try {
            ...
            const url = `https://mern-snipper-manager-api.herokuapp.com/api/snippetsProjects`
            const config = {
                headers:{
    ...
    const getSnippetProjectByIdfn = async(id)=>{
        ...
        setIsReady(true)
        try {
            const url = `https://mern-snipper-manager-api.herokuapp.com/api/snippetsProjects/${id}`
            const config = {
                headers:{
                    Authorization:`Bearer ${user.token}`
                }
    ...
    const newSnippetfn = async(snippetProjectId)=>{
        try {
            const url = `https://mern-snipper-manager-api.herokuapp.com/api/snippets`
            const config = {
                headers:{
                    Authorization:`Bearer ${user.token}`
                }
    ...
    const deleteSnippetfn =async(id)=>{
        try {
            const url =`https://mern-snipper-manager-api.herokuapp.com/api/snippets/${id}`
            const config = {
                headers:{
                    Authorization:`Bearer ${user.token}`
                }
    ...
    const updateSaveSnippetfn = async(inputs)=>{
        ...
        try {
            const url =`https://mern-snipper-manager-api.herokuapp.com/api/snippets/${inputs._id}`
            console.log(url)
            const config = {
                headers:{
                    Authorization:`Bearer ${user.token}`
